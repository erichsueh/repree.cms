...
[assembly:ModelsBuilderAssembly(PureLive = true, SourceHash = "936b2dc40e9e948c")]
...
#pragma warning restore 0109
		...
		/// Test Body
		///</summary>
		[ImplementPropertyType("testBody")]
		public string TestBody
		{
			get { return this.GetPropertyValue<string>("testBody"); }
		}
	...
	/// <summary>RepreeHome</summary>
	[PublishedContentModel("repreeHome")]
	public partial class RepreeHome : PublishedContentModel
	{
#pragma warning disable 0109 // new is redundant
		public new const string ModelTypeAlias = "repreeHome";
		public new const PublishedItemType ModelItemType = PublishedItemType.Content;
#pragma warning restore 0109

		public RepreeHome(IPublishedContent content)
			: base(content)
		{ }
...
#pragma warning restore 0109
		...
		public static PublishedPropertyType GetModelPropertyType<TValue>(Expression<Func<RepreeHome, TValue>> selector)
		{
			return PublishedContentModelUtility.GetModelPropertyType(GetModelContentType(), selector);
		}
		...
		///<summary>
		/// Page Title: Main title page of repree?
		///</summary>
		...
		///<summary>
		/// RepreeContentPickerTEst
		///</summary>
		[ImplementPropertyType("repreeContentPickerTEst")]
		public Newtonsoft.Json.Linq.JToken RepreeContentPickerTest
		{
			get { return this.GetPropertyValue<Newtonsoft.Json.Linq.JToken>("repreeContentPickerTEst"); }
		}
	}
